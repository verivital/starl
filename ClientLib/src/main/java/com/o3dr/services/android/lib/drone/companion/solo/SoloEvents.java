...
public class SoloEvents {
     ...
     *
     * @see com.o3dr.services.android.lib.drone.companion.solo.tlv.SoloGoproState
     */
     ...
     * @see com.o3dr.services.android.lib.drone.companion.solo.tlv.SoloGoproStateV2
     */
     ...
     *
     * @see SoloEventExtras#EXTRA_SOLO_BUTTON_EVENT
     */
     ...
     *
     * @see SoloEventExtras#EXTRA_SOLO_MESSAGE_DATA
     */
     ...
     * @see SoloEventExtras#EXTRA_SOLO_CONTROLLER_VERSION
     * @see SoloEventExtras#EXTRA_SOLO_CONTROLLER_FIRMWARE_VERSION
     * @see SoloEventExtras#EXTRA_SOLO_AUTOPILOT_VERSION
     * @see SoloEventExtras#EXTRA_SOLO_VEHICLE_VERSION
     * @see SoloEventExtras#EXTRA_SOLO_GIMBAL_VERSION
     */
     ...
     * @see SoloEventExtras#EXTRA_SOLO_CONTROLLER_MODE
     */
     ...
     * @see SoloEventExtras#EXTRA_SOLO_CONTROLLER_UNIT
     */
