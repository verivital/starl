...
public class RealisticSimMotionAutomaton_ghost extends MotionAutomaton_GhostAerial {
	private SimGpsProvider gpsp;
	private String name;
	private Model_GhostAerial my_model;

	public RealisticSimMotionAutomaton_ghost(GlobalVarHolder gvh, SimGpsProvider gpsp) {
		super(gvh, null);
		name = gvh.id.getName();
		this.gpsp = gpsp;
		this.my_model = (Model_GhostAerial)gvh.plat.model;
	}
