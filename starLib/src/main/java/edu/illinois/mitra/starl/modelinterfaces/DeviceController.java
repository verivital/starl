...
import com.parrot.arsdk.arcommands.ARCommandMiniDronePilotingSettingsMaxAltitudeListener;
import com.parrot.arsdk.arcommands.ARCommandMiniDronePilotingSettingsMaxTiltListener;
...
public class DeviceController implements ARCommandCommonCommonStateBatteryStateChangedListener, ARCommandMiniDronePilotingSettingsMaxTiltListener, ARCommandMiniDronePilotingSettingsMaxAltitudeListener
{
    ...
    protected void registerARCommandsListener ()
    {
        ...
        ARCommand.setMiniDronePilotingSettingsMaxTiltListener(this);
        ARCommand.setMiniDronePilotingSettingsMaxAltitudeListener(this);
    ...
    protected void unregisterARCommandsListener ()
    {
        ...
        ARCommand.setMiniDronePilotingSettingsMaxTiltListener(null);
        ARCommand.setMiniDronePilotingSettingsMaxAltitudeListener(null);
    }
    ...
    public void sendMaxTilt(float maxTilt) {
        ...
        cmdError = cmd.setMiniDronePilotingSettingsMaxTilt(maxTilt);
        ...
        if(cmdError == ARCOMMANDS_GENERATOR_ERROR_ENUM.ARCOMMANDS_GENERATOR_OK) {
            ...
            if(netError != ARNETWORK_ERROR_ENUM.ARNETWORK_OK) {
                ...
                ARSALPrint.e(TAG, "netManager failed to send data " + netError.toString());
            }
            cmd.dispose();
        }
    }
    ...
    public void sendMaxAltitude(float maxAlt) {
        ...
        cmdError = cmd.setMiniDronePilotingSettingsMaxAltitude(maxAlt);
    ...
    @Override
    public void onMiniDronePilotingSettingsMaxTiltUpdate(float v) {
        Log.e(TAG, "Max tilt angle = " + v);
    }

    @Override
    public void onMiniDronePilotingSettingsMaxAltitudeUpdate(float v) {
        Log.e(TAG, "Max altitude = " + v);
    }
